...
class CardDB(dict):
    ...
    def initialize(self, locale="ruRU"):
        ...
        exclude = [
            ...
            'SCH_259',
            # neutral-scholo, while this weapon is played, each turn begin allows me to compare the drawn card and other cards.
        ...
        for id, card in db.items():
            ...
            if card.card_set == CardSet.DARKMOON_FAIRE:  # 1466
                ...
                yes = True
            if card.card_set == 15:
                if card.id in ['AT_132_DRUIDe', "AT_132_SHAMANa", "AT_132_SHAMANb", "AT_132_SHAMANc", "AT_132_SHAMANd",
                               "AT_132_ROGUEt", ]:  ## cardset 15
                    yes = True
            if yes:
